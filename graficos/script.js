document.addEventListener('DOMContentLoaded', () => {
  ...
  const graphsData = {
    ...
    item1: [
      ...
      { title: "Desempenho Fastshop Global (1,8%)", description: "Grafico responsavel pela visualização de desempenho em evolução dia a dia ", url: "https://docs.google.com/spreadsheets/d/e/2PACX-1vTtvK3X3YMZzQe3M1I5lz6AkpNcdR8RomqEPefP_meogRr3LeZXELjeHajUYf4Cv_lFItd7YFf84NLf/pubchart?oid=513829514&format=interactive" },
      { title: "Desempenho 4pshopping Global (1,8%)", description: "Grafico responsavel pela visualização de desempenho em evolução dia a dia ", url: "https://docs.google.com/spreadsheets/d/e/2PACX-1vTtvK3X3YMZzQe3M1I5lz6AkpNcdR8RomqEPefP_meogRr3LeZXELjeHajUYf4Cv_lFItd7YFf84NLf/pubchart?oid=1626048075&format=interactive" },
